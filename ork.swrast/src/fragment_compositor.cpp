...
int rend_fraglist::DepthComplexity() const
{
	struct countvisitor : public rend_fraglist_visitor
	{
		...
		void Reset() override {}
		ork::CVector3 Composite(const ork::CVector3&clrcolor) override { return ork::CVector3(); }
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
PreShadedFragmentPool::PreShadedFragmentPool()
	: miNumPreFrags(0)
	, miMaxPreFrags(1<<16)
{
	mPreFrags.resize(miMaxPreFrags);
}
void PreShadedFragmentPool::Reset()
{
	miNumPreFrags = 0;
}
PreShadedFragment& PreShadedFragmentPool::AllocPreFrag()
{
